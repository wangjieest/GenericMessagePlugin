...
struct UE_DEPRECATED(5.3, "Options are not used anymore to customize the property customization behavior.") MESSAGETAGSEDITOR_API FMessageTagCustomizationOptions
{
