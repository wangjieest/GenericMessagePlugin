> **Archived.** This is the README as it stood before the 2026-07 rewrite, kept verbatim for
> reference. Start from [README.md](README.md) instead — it supersedes everything here.
>
> Two things below are known to be wrong and were corrected in the current docs:
> the *Performance & Extreme Optimization* section claims a "minimal 4-frame send path … verified
> at the byte level", which measurement disproved (see
> [docs/dispatch-stack-measured.md](docs/dispatch-stack-measured.md) — 9 frames unoptimized,
> 3 optimized with a baked key), and the unit-test count is now 69, not 68.
>
> One image link below (`./pics/11.jpg`) was already broken in the original — the file is
> `11.png`. Left as-is so this stays a faithful snapshot.
