...
#include "GMPBPCompilerExtension.h"
...
void UGMPBPCompilerExtension::ProcessBlueprintCompiled(const FKismetCompilerContext& CompilationContext, const FBlueprintCompiledData& Data)
{
	...
	for (UEdGraph* Graph : Graphs)
	{
		for (UEdGraphNode* GraphNode : Graph->Nodes)
		{
			...
			GMP_Private::InitFunctionNodeMetaData(*FunctionNode, CompilationContext.OldClass, CompilationContext.Blueprint);
		}
	}
}

#include "GMPCore.h"
UGMPBPCompilerExtension::UGMPBPCompilerExtension(const FObjectInitializer& ObjectInitializer)
