...
namespace Serializer
{
	...
	template<typename T, int Tag = TypeTraits::TDisjunction<TCustomNetSerializer<T>, TTraitsPODArray<T>, TTraitsArrayNetAr<T>, TTraitsArrayNormal<T>, TTraitsWithoutNetAr<T>>::Tag>
